...
# --- 1. 选面工具 (升级版：支持多选) ---
    ...
    # --- 17. 倒圆角 (修正版 - 对应 VBA 宏实现) ---
    # {
    #     "type": "function",
    #     "function": {
    #         "name": "apply_fillet",
    #         "description": "【必须先选面】对**当前已选中的**面或边线执行倒圆角操作。\n⚠️ 执行逻辑：此工具本身不包含选面功能。你必须在调用此工具的前一步，调用 `select_face` 选中要倒角的边缘或面。如果前一步没有选择操作，此工具将失效。",
    #         "parameters": {
    #             "type": "object",
    #             "properties": {
    #                 "radius_m": {
    #                     "type": "number",
    #                     "description": "倒圆角半径（米）。例如：0.005 代表 5mm。"
    #                 }
    #             },
    #             "required": ["radius_m"]
    #         }
